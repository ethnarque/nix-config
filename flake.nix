  ...
  outputs = inputs @ { self, darwin, home-manager, nixpkgs, nur, ... }:
    {
      ...
      nixosConfigurations."nixos-vm" = let username = "pml"; in nixpkgs.lib.nixosSystem rec {
      ...
      darwinConfigurations."magda" = let username = "pmlogist"; in darwin.lib.darwinSystem rec {
